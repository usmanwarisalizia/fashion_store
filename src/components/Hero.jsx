    ...
    return (
        <section className="relative overflow-hidden bg-gradient-to-br from-gray-50 via-white to-indigo-50">
            ...
            <div className="absolute inset-0 overflow-hidden">
                <div className="absolute -top-40 -right-40 w-80 h-80 bg-gradient-to-r from-purple-300 to-pink-300 rounded-full mix-blend-multiply filter blur-3xl opacity-30 animate-blob"></div>
                <div className="absolute -bottom-40 -left-40 w-80 h-80 bg-gradient-to-r from-blue-300 to-cyan-300 rounded-full mix-blend-multiply filter blur-3xl opacity-30 animate-blob animation-delay-2000"></div>
                <div className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 w-80 h-80 bg-gradient-to-r from-green-300 to-emerald-300 rounded-full mix-blend-multiply filter blur-3xl opacity-30 animate-blob animation-delay-4000"></div>
            </div>
            ...
            <div className="container mx-auto px-4 py-8 md:py-12 lg:py-20 relative z-10">
                <div className="grid lg:grid-cols-2 gap-6 md:gap-10 lg:gap-16 items-center">
                    ...
                    <div className="order-2 lg:order-1 animate-fade-in-up">
                        <div className="inline-flex items-center gap-2 bg-gradient-to-r from-indigo-500/10 to-purple-500/10 text-indigo-600 px-4 py-2 rounded-full text-sm font-medium mb-4 md:mb-6 animate-pulse">
                        ...
                        <h1 className="text-3xl md:text-4xl lg:text-5xl xl:text-6xl font-bold text-gray-900 mb-4 md:mb-6 leading-tight animate-fade-in-up animation-delay-200">
                            Premium Fashion
                            <span className="block text-transparent bg-clip-text bg-gradient-to-r from-indigo-600 to-purple-600 animate-gradient-x">
                                For Every Occasion
                            </span>
                        </h1>
                        ...
                        <div className="flex flex-wrap gap-3 md:gap-4 mb-8 md:mb-12 animate-fade-in-up animation-delay-800">
                            <button
                                ...
                                className="group bg-gradient-to-r from-indigo-600 to-purple-600 text-white px-6 md:px-8 py-3 rounded-xl font-medium hover:shadow-lg hover:shadow-indigo-200 transition-all duration-300 flex items-center gap-2 text-sm md:text-base transform hover:-translate-y-1"
                            >
                                <span>Shop Now</span>
                        ...
                        <div className="grid grid-cols-3 gap-4 md:gap-6 animate-fade-in-up animation-delay-1000">
                            <div className="text-center group hover:scale-105 transition-transform duration-300">
                                <div className="bg-gradient-to-br from-blue-100 to-blue-50 w-12 h-12 md:w-14 md:h-14 rounded-full flex items-center justify-center mx-auto mb-3 group-hover:shadow-lg transition-shadow">
                            ...
                            <div className="text-center group hover:scale-105 transition-transform duration-300">
                                <div className="bg-gradient-to-br from-green-100 to-green-50 w-12 h-12 md:w-14 md:h-14 rounded-full flex items-center justify-center mx-auto mb-3 group-hover:shadow-lg transition-shadow">
                            ...
                            <div className="text-center group hover:scale-105 transition-transform duration-300">
                                <div className="bg-gradient-to-br from-purple-100 to-purple-50 w-12 h-12 md:w-14 md:h-14 rounded-full flex items-center justify-center mx-auto mb-3 group-hover:shadow-lg transition-shadow">
                    ...
                    <div className="relative order-1 lg:order-2 mb-8 lg:mb-0">
                        ...
                        >
                            ...
                            <div className="absolute inset-0 bg-gradient-to-br from-indigo-500 to-purple-600 rounded-3xl lg:rounded-none overflow-hidden">
                            ...
                            {/* Sale Badge */}
                            <div className="absolute top-4 right-4 bg-gradient-to-r from-red-500 to-orange-500 text-white px-4 py-2 rounded-full shadow-lg z-10 animate-bounce-slow">
                                <span className="text-sm font-bold">UP TO 50% OFF</span>
                            </div>
                        </div>

                        {/* Animated Decorative Elements */}
                        <div className="absolute -top-4 -right-4 w-8 h-8 bg-gradient-to-r from-indigo-400 to-purple-400 rounded-full animate-ping opacity-20"></div>
                        <div className="absolute bottom-8 -right-4 w-6 h-6 bg-gradient-to-r from-pink-400 to-rose-400 rounded-full animate-ping opacity-20 animation-delay-1000"></div>
                    </div>
                </div>
            </div>
        </section>
